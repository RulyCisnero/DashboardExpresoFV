...
router.post('/', validarLocalidad,checkLocalidadNombreDuplicado, LocalidadController.createLocalidad);
router.put('/:id',validateLocalidadId, checkLocalidadExists, validarLocalidad,checkLocalidadNombreDuplicado, LocalidadController.updateLocalidad);
